...
class BrowserHistory extends Component {
  ...
  onClickDelete = id => {
    ...
    const updateResults = searchResults.filter(eachItem => eachItem.id !== id)

    this.setState({searchResults: updateResults})
  }
      ...
      <div className="browser-app">
        <div className="browser-header">
          ...
          <div className="search-container">
            <button type="button" className="search-btn" testid="Search">
              <img
